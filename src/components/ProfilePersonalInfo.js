                ...
                <div className={isMobile ? '' : classes.container}>
                    <Grid container spacing={3} direction="column">
                        <Grid item xs container>
                            <Grid item xs={10}>
                                <Typography variant="h2" color="primary" align="center">Personal
                        ...
                        <Grid item container spacing={3} direction="row">
                            ...
                            <Grid className={isMobile ? "" : classes.container} item xs={7} container direction="row"
                                  spacing={2}
                                  align="center">
                                <Grid item xs={5} className={isMobile ? classes.fields : classes.desktopFields}
                                      container spacing={2}>
                                    <Grid item xs={12}>
                                ...
                                <Grid className={isMobile ? classes.mobileInput : classes.desktopInput} item xs={5}
                                      container
                                      spacing={2}>
                                    <Grid item xs={12}>
                                    ...
                                    <Grid item xs={12}>
                                        <TextField disabled={!editable}
                                                   variant="standard" value={email ? email : "enter email.."}
                                                   align="left"
                                    ...
                                    <Grid item xs={12}>
                                        <TextField disabled={!editable}
                                                   variant="standard"
                                                   value={phone_number ? phone_number : "enter phone number.."}
                                                   align="left"
                                                   onChange={changePhone}/>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField disabled={!editable}
                                                   variant="standard" value={address ? address : "enter address.."}
                                                   align="left"

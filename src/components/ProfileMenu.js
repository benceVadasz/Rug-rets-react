            ...
            <Paper elevation={3} style={classes.paper}>
                <Grid container spacing={2} direction="column">
                    <Grid item xs align="center">
                        <Avatar alt="pic" variant="circular" style={classes.avatar}/>
                    </Grid>
                    <Grid item xs>
                    ...
                    <Grid item xs>
                        <Link to="/profile" style={classes.link}>
                            <Button variant="contained" color="primary" size="large" style={classes.button}
                                    startIcon={<PersonIcon fontSize="large"/>}>Profile Info</Button>
                        </Link>
                    </Grid>
                    <Grid item xs>
                        <Link to="/profile/favorites" style={classes.link}>
                            <Button variant="contained" color="primary" size="large" style={classes.button}
                                    startIcon={<FavoriteIcon fontSize="large"/>}>Favorites</Button>
                        </Link>
                    </Grid>
                    <Grid item xs>
                        <Link to="/profile/applications" style={classes.link}>
                            <Button variant="contained" color="primary" size="large" style={classes.button}
                                    startIcon={<DescriptionIcon fontSize="large"/>}>Applications</Button>
                        </Link>
                    </Grid>
                    <Grid item xs>
                        <Link to="/profile/assessments" style={classes.link}>
                            <Button variant="contained" color="primary" size="large" style={classes.button}
                                    startIcon={<AssessmentIcon fontSize="large"/>}>Assessments</Button>
                        </Link>
                    </Grid>
                </Grid>
            </Paper>
